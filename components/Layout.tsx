  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className={`${fullWidth ? 'w-full px-4 md:px-12' : 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-12'} h-20 flex items-center justify-between transition-all duration-500`}>
      ...
      <footer className="bg-white border-t border-slate-200 py-10">
        <div className={`${fullWidth ? 'w-full px-4 md:px-12' : 'max-w-7xl mx-auto px-4'} text-center space-y-4 transition-all duration-500`}>
